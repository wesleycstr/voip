            ...
            <table class="table">
                ...
                /*
                    if(isset($_POST['atualizar'])){
                        ...
                        $exec = shell_exec('./exec-informe '.$matricula);
                        //echo "<pre>$output</pre>";
                ...
                ?>
                    ...
                    $query = "SELECT * FROM indicadores ORDER BY matricula";
                        ...
                        echo "<tr>";
                        echo "<td>$matricula</td><td>$nome</td><td>$meta_atual</td><td>$meta_anterior</td><td>$valor_atual</td><td><button type='submit' name='acessar' value='$matricula' formaction='./individual.php?matricula=$matricula' class='btn btn-primary m-2'>ACESSAR</button></td>";
                        echo "</tr>";
                        echo "</form>";
                    }
                    //echo $meta_atual;
